...
bot = telebot.TeleBot('7495909626:AAHLkxTOODwR5v05mAZ_s5n9mGIPomhjt5I')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🚀🚀\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- @Bgmiprince KA KALA JADU"
    bot.reply_to(message, response)
...
Buy From :- @Bgmiprince @X37335
Official Channel :- https://t.me/rangercheat0
'''
...
3. MAKE SURE YOU JOINED https://t.me/rangercheat0 OTHERWISE NOT WORK
...
bot.polling() bot.reply_to(message, response)
